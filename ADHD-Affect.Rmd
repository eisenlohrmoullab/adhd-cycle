...
AdultADHDDailyData <- read_sav("2023.02.03. DailySummary with earlylut coding.sav")
...
## AFFECT AND EATING MODELS AND GRAPHS
...
model1cr <- lmer(DRSP_2 ~ periov_LH+ midfol_LH+perimenstrual_LH + midluteal_LH+
              (1 + OV_MF+ML_PERI | ID), data = AdultADHDDailyData)
...
#Midfol as reference group
Phase_DRSP_1_MF <- lmerTest::lmer(DRSP_1 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1+periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH|ID),
                                     data= AdultADHDDailyData)
summary(Phase_DRSP_1_MF)
test<-allFit(Phase_DRSP_1_MF)
test.results<-summary(test)
#PeriOv as reference group
Phase_DRSP_1_PO <- lmerTest::lmer(DRSP_1 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1+midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_1_PO)
#EarlyLut as reference group
Phase_DRSP_1_EL <- lmerTest::lmer(DRSP_1 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1+midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH|ID),
                                     data = AdultADHDDailyData)
summary(Phase_DRSP_1_EL)
#Midluteal as reference group
Phase_DRSP_1_ML <- lmerTest::lmer(DRSP_1 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1+midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH|ID),
                                     data = AdultADHDDailyData)
summary(Phase_DRSP_1_ML)
#Perimenstrual as reference group
Phase_DRSP_1_PM <- lmerTest::lmer(DRSP_1 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1+midfol_LH + periov_LH +earlylut_LH + midluteal_LH|ID),
                                     data = AdultADHDDailyData)
summary(Phase_DRSP_1_PM)
```


#DRSP 1-Depressed Mood Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Hormone effects
DRSP_1_hormones <- lmerTest::lmer(DRSP_1 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_1_hormones)
```
#DRSP_2 - Hopeless Models
```{r}
#2/2/23 effects of phase on daily symptoms - DRSP 1 = depressed
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_2_MF <- lmerTest::lmer(DRSP_2 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_2_MF)
#PeriOv as reference group
Phase_DRSP_2_PO <- lmerTest::lmer(DRSP_2 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_2_PO)
#EarlyLut as reference group
Phase_DRSP_2_EL <- lmerTest::lmer(DRSP_2 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_2_EL)
#Midluteal as reference group
Phase_DRSP_2_ML <- lmerTest::lmer(DRSP_2 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_2_ML)
#Perimenstrual as reference group
Phase_DRSP_2_PM <- lmerTest::lmer(DRSP_2 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_2_PM)

#Hormone effects
DRSP_2_hormones <- lmerTest::lmer(DRSP_2 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_2_hormones)
```

#DRSP_3 - Worthless/Guilty Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_3_MF <- lmerTest::lmer(DRSP_3 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_3_MF)
#PeriOv as reference group
Phase_DRSP_3_PO <- lmerTest::lmer(DRSP_3 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_3_PO)
#EarlyLut as reference group
Phase_DRSP_3_EL <- lmerTest::lmer(DRSP_3 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_3_EL)
#Midluteal as reference group
Phase_DRSP_3_ML <- lmerTest::lmer(DRSP_3 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_3_ML)
#Perimenstrual as reference group
Phase_DRSP_3_PM <- lmerTest::lmer(DRSP_3 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_3_PM)

#Hormone effects
DRSP_3_hormones <- lmerTest::lmer(DRSP_3 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_3_hormones)
```
#DRSP_4 - Anxious Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_4_MF <- lmerTest::lmer(DRSP_4 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_4_MF)
#PeriOv as reference group
Phase_DRSP_4_PO <- lmerTest::lmer(DRSP_4 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_4_PO)
#EarlyLut as reference group
Phase_DRSP_4_EL <- lmerTest::lmer(DRSP_4 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_4_EL)
#Midluteal as reference group
Phase_DRSP_4_ML <- lmerTest::lmer(DRSP_4 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_4_ML)
#Perimenstrual as reference group
Phase_DRSP_4_PM <- lmerTest::lmer(DRSP_4 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_4_PM)

#Hormone effects
DRSP_4_hormones <- lmerTest::lmer(DRSP_4 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_4_hormones)
```
#DRSP_5 - Mood Swings Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_5_MF <- lmerTest::lmer(DRSP_5 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_5_MF)
#PeriOv as reference group
Phase_DRSP_5_PO <- lmerTest::lmer(DRSP_5 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_5_PO)
#EarlyLut as reference group
Phase_DRSP_5_EL <- lmerTest::lmer(DRSP_5 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_5_EL)
#Midluteal as reference group
Phase_DRSP_5_ML <- lmerTest::lmer(DRSP_5 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_5_ML)
#Perimenstrual as reference group
Phase_DRSP_5_PM <- lmerTest::lmer(DRSP_5 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_5_PM)

#Hormone effects
DRSP_5_hormones <- lmerTest::lmer(DRSP_5 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_5_hormones)
```
#DRSP_6 - Sensitive Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_6_MF <- lmerTest::lmer(DRSP_6 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_6_MF)
#PeriOv as reference group
Phase_DRSP_6_PO <- lmerTest::lmer(DRSP_6 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_6_PO)
#EarlyLut as reference group
Phase_DRSP_6_EL <- lmerTest::lmer(DRSP_6 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_6_EL)
#Midluteal as reference group
Phase_DRSP_6_ML <- lmerTest::lmer(DRSP_6 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_6_ML)
#Perimenstrual as reference group
Phase_DRSP_6_PM <- lmerTest::lmer(DRSP_6 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_6_PM)

#Hormone effects
DRSP_6_hormones <- lmerTest::lmer(DRSP_6 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_6_hormones)
```
#DRSP_7 - Anger/Irritability Models
```{r}
#2/2/23 effects of phase on daily symptoms - DRSP 7 = anger irritability
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_7_MF <- lmerTest::lmer(DRSP_7 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_7_MF)
#PeriOv as reference group
Phase_DRSP_7_PO <- lmerTest::lmer(DRSP_7 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_7_PO)
#EarlyLut as reference group
Phase_DRSP_7_EL <- lmerTest::lmer(DRSP_7 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_7_EL)
#Midluteal as reference group
Phase_DRSP_7_ML <- lmerTest::lmer(DRSP_7 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_7_ML)
#Perimenstrual as reference group
Phase_DRSP_7_PM <- lmerTest::lmer(DRSP_7 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_7_PM)

#Hormone effects
DRSP_7_hormones <- lmerTest::lmer(DRSP_7 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_7_hormones)
```
#DRSP_8 - Conflicts Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_8_MF <- lmerTest::lmer(DRSP_8 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_8_MF)
#PeriOv as reference group
Phase_DRSP_8_PO <- lmerTest::lmer(DRSP_8 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_8_PO)
#EarlyLut as reference group
Phase_DRSP_8_EL <- lmerTest::lmer(DRSP_8 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_8_EL)
#Midluteal as reference group
Phase_DRSP_8_ML <- lmerTest::lmer(DRSP_8 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_8_ML)
#Perimenstrual as reference group
Phase_DRSP_8_PM <- lmerTest::lmer(DRSP_8 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_8_PM)

#Hormone effects
DRSP_8_hormones <- lmerTest::lmer(DRSP_8 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_8_hormones)
```
#DRSP 9 - Less Interest Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_9_MF <- lmerTest::lmer(DRSP_9 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_9_MF)
#PeriOv as reference group
Phase_DRSP_9_PO <- lmerTest::lmer(DRSP_9 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_9_PO)
#EarlyLut as reference group
Phase_DRSP_9_EL <- lmerTest::lmer(DRSP_9 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_9_EL)
#Midluteal as reference group
Phase_DRSP_9_ML <- lmerTest::lmer(DRSP_9 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_9_ML)
#Perimenstrual as reference group
Phase_DRSP_9_PM <- lmerTest::lmer(DRSP_9 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_9_PM)

#Hormone effects
DRSP_9_hormones <- lmerTest::lmer(DRSP_9 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_9_hormones)
```
#DRSP 10 - Difficulty Concentrating Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_10_MF <- lmerTest::lmer(DRSP_10 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_10_MF)
#PeriOv as reference group
Phase_DRSP_10_PO <- lmerTest::lmer(DRSP_10 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_10_PO)
#EarlyLut as reference group
Phase_DRSP_10_EL <- lmerTest::lmer(DRSP_10 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_10_EL)
#Midluteal as reference group
Phase_DRSP_10_ML <- lmerTest::lmer(DRSP_10 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_10_ML)
#Perimenstrual as reference group
Phase_DRSP_10_PM <- lmerTest::lmer(DRSP_10 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_10_PM)

#Hormone effects
DRSP_10_hormones <- lmerTest::lmer(DRSP_10 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_10_hormones)
```
#DRSP_11 - Tired Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_11_MF <- lmerTest::lmer(DRSP_11 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_11_MF)
#PeriOv as reference group
Phase_DRSP_11_PO <- lmerTest::lmer(DRSP_11 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_11_PO)
#EarlyLut as reference group
Phase_DRSP_11_EL <- lmerTest::lmer(DRSP_11 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_11_EL)
#Midluteal as reference group
Phase_DRSP_11_ML <- lmerTest::lmer(DRSP_11 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_11_ML)
#Perimenstrual as reference group
Phase_DRSP_11_PM <- lmerTest::lmer(DRSP_11 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_11_PM)

#Hormone effects
DRSP_11_hormones <- lmerTest::lmer(DRSP_11 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_11_hormones)
```
#DRSP_12 - Increased Appetite Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_12_MF <- lmerTest::lmer(DRSP_12 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_12_MF)
#PeriOv as reference group
Phase_DRSP_12_PO <- lmerTest::lmer(DRSP_12 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_12_PO)
#EarlyLut as reference group
Phase_DRSP_12_EL <- lmerTest::lmer(DRSP_12 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_12_EL)
#Midluteal as reference group
Phase_DRSP_12_ML <- lmerTest::lmer(DRSP_12 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_12_ML)
#Perimenstrual as reference group
Phase_DRSP_12_PM <- lmerTest::lmer(DRSP_12 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_12_PM)

#Hormone effects
DRSP_12_hormones <- lmerTest::lmer(DRSP_12 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_12_hormones)
```
#DRSP_13 - Food Cravings Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_13_MF <- lmerTest::lmer(DRSP_13 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_13_MF)
#PeriOv as reference group
Phase_DRSP_13_PO <- lmerTest::lmer(DRSP_13 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_13_PO)
#EarlyLut as reference group
Phase_DRSP_13_EL <- lmerTest::lmer(DRSP_13 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_13_EL)
#Midluteal as reference group
Phase_DRSP_13_ML <- lmerTest::lmer(DRSP_13 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_13_ML)
#Perimenstrual as reference group
Phase_DRSP_13_PM <- lmerTest::lmer(DRSP_13 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_13_PM)

#Hormone effects
DRSP_13_hormones <- lmerTest::lmer(DRSP_13 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_13_hormones)
```
#DRSP_14 - Sleep More Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_14_MF <- lmerTest::lmer(DRSP_14 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_14_MF)
#PeriOv as reference group
Phase_DRSP_14_PO <- lmerTest::lmer(DRSP_14 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_14_PO)
#EarlyLut as reference group
Phase_DRSP_14_EL <- lmerTest::lmer(DRSP_14 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_14_EL)
#Midluteal as reference group
Phase_DRSP_14_ML <- lmerTest::lmer(DRSP_14 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_14_ML)
#Perimenstrual as reference group
Phase_DRSP_14_PM <- lmerTest::lmer(DRSP_14 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_14_PM)

#Hormone effects
DRSP_14_hormones <- lmerTest::lmer(DRSP_14 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_14_hormones)
```
#DRSP_15 - Trouble Sleeping Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_15_MF <- lmerTest::lmer(DRSP_15 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_15_MF)
#PeriOv as reference group
Phase_DRSP_15_PO <- lmerTest::lmer(DRSP_15 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_15_PO)
#EarlyLut as reference group
Phase_DRSP_15_EL <- lmerTest::lmer(DRSP_15 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_15_EL)
#Midluteal as reference group
Phase_DRSP_15_ML <- lmerTest::lmer(DRSP_15 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_15_ML)
#Perimenstrual as reference group
Phase_DRSP_15_PM <- lmerTest::lmer(DRSP_15 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_15_PM)

#Hormone effects
DRSP_15_hormones <- lmerTest::lmer(DRSP_15 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_15_hormones)
```
#DRSP_16 - Overwhelmed Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_16_MF <- lmerTest::lmer(DRSP_16 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_16_MF)
#PeriOv as reference group
Phase_DRSP_16_PO <- lmerTest::lmer(DRSP_16 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_16_PO)
#EarlyLut as reference group
Phase_DRSP_16_EL <- lmerTest::lmer(DRSP_16 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_16_EL)
#Midluteal as reference group
Phase_DRSP_16_ML <- lmerTest::lmer(DRSP_16 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_16_ML)
#Perimenstrual as reference group
Phase_DRSP_16_PM <- lmerTest::lmer(DRSP_16 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_16_PM)

#Hormone effects
DRSP_16_hormones <- lmerTest::lmer(DRSP_16 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_16_hormones)
```
#DRSP_17 - Out of Control Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_17_MF <- lmerTest::lmer(DRSP_17 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_17_MF)
#PeriOv as reference group
Phase_DRSP_17_PO <- lmerTest::lmer(DRSP_17 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_17_PO)
#EarlyLut as reference group
Phase_DRSP_17_EL <- lmerTest::lmer(DRSP_17 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_17_EL)
#Midluteal as reference group
Phase_DRSP_17_ML <- lmerTest::lmer(DRSP_17 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_17_ML)
#Perimenstrual as reference group
Phase_DRSP_17_PM <- lmerTest::lmer(DRSP_17 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_17_PM)

#Hormone effects
DRSP_17_hormones <- lmerTest::lmer(DRSP_17 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_17_hormones)
```
#DRSP_22 - Impairment in Productivity Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_22_MF <- lmerTest::lmer(DRSP_22 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_22_MF)
#PeriOv as reference group
Phase_DRSP_22_PO <- lmerTest::lmer(DRSP_22 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_22_PO)
#EarlyLut as reference group
Phase_DRSP_22_EL <- lmerTest::lmer(DRSP_22 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_22_EL)
#Midluteal as reference group
Phase_DRSP_22_ML <- lmerTest::lmer(DRSP_22 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_22_ML)
#Perimenstrual as reference group
Phase_DRSP_22_PM <- lmerTest::lmer(DRSP_22 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_22_PM)

#Hormone effects
DRSP_22_hormones <- lmerTest::lmer(DRSP_22 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_22_hormones)
```
#DRSP_23 - Impairment in Relationships Models
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_DRSP_23_MF <- lmerTest::lmer(DRSP_23 ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_23_MF)
#PeriOv as reference group
Phase_DRSP_23_PO <- lmerTest::lmer(DRSP_23 ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_23_PO)
#EarlyLut as reference group
Phase_DRSP_23_EL <- lmerTest::lmer(DRSP_23 ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_23_EL)
#Midluteal as reference group
Phase_DRSP_23_ML <- lmerTest::lmer(DRSP_23 ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_23_ML)
#Perimenstrual as reference group
Phase_DRSP_23_PM <- lmerTest::lmer(DRSP_23 ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_DRSP_23_PM)

#Hormone effects
DRSP_23_hormones <- lmerTest::lmer(DRSP_23 ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(DRSP_23_hormones)
```

#Graphing DRSP variables by phase
```{r}
#Plot Daily Data by Phase
#set up labels
AdultADHDDailyData$cyclephase_names <- factor(AdultADHDDailyData$cyclephase_LH, levels = c(1,2,3,4,5), labels = c("PO", "EL", "ML", "PM", "MF"))
...
#person-mean-center
data_for_plot1a <- AdultADHDDailyData %>% group_by(ID, cyclephase_names) %>% 
  summarize(DRSP_23.m=mean(DRSP_23.m),
            DRSP_23phase.m = mean(DRSP_23, na.rm = TRUE),
            DRSP_23phase.d = DRSP_23phase.m - DRSP_23.m)%>%
filter(!is.na(cyclephase_names))

plot1a <- data_for_plot1a %>% 
  group_by(cyclephase_names) %>%
  summarize(grand.m.DRSP_23.d = mean(DRSP_23phase.d, na.rm=T),
            se=sd(DRSP_23phase.d, na.rm=T)/sqrt(n())) %>%
  #can save the above code into a separate dataset if preferred (dont have to do it in one line w/ ggplot)
  ggplot(aes(x=cyclephase_names, y=grand.m.DRSP_23.d))+
  geom_line(group=1)+
  ##everything from here down is just formatting
  scale_x_discrete(labels=c("PO" = "Periovulatory",
                            "EL" = "Earlyluteal",
                            ...
                            "PM" = "Perimenstrual",
                            "MF" = "Midfollicular" ))+
  geom_errorbar(aes(ymin=grand.m.DRSP_23.d-se, 
                    ymax=grand.m.DRSP_23.d+se), 
                size=0.5, width=0.5, position=position_dodge())+
  geom_hline(yintercept=0.0, color="red", linetype="dashed")+
  theme_bw()+
  xlab("Cycle Phase")+
  ylab("Person-Centered Impaired Relationships")
#run plot1a in console to see plot
plot1a
```

#Graphing DRSP variables by day
```{r}
#Graphing DRSP Variables
AdultADHDDailyData %>% group_by(daycountLH) %>%
  summarize(personcentered.dev = mean(DRSP_23.d, na.rm=T),
            se=sd(DRSP_23.d, na.rm=T)/sqrt(n())) %>%
  arrange(daycountLH) %>%
  mutate(roll= rollapply(personcentered.dev, 3, 
                         mean, align = "center", fill=NA)) %>%
  ggplot(aes(x=daycountLH, y=roll))+
...
geom_hline(yintercept = 0, linetype="dashed", col="red")+
  ...
  theme_bw()+
  xlab("Cycle Day (based on LH-surge and menses self-report)")+
  ylab("Person-Centered Impairment in Relationships")
```


#Changes in trait impulsivity
```{r}
#2/2/23 effects of phase on daily symptoms 
# model 2: predicting a linear outcome from one predictor, random intercepts, no cycle vars
badhormones <- c(206, 214, 221, 228)
...
#Midfol as reference group
Phase_UPPS_NU_avg_MF <- lmerTest::lmer(UPPS_NU_avg ~ periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_UPPS_NU_avg_MF)
#PeriOv as reference group
Phase_UPPS_NU_avg_PO <- lmerTest::lmer(UPPS_NU_avg ~ midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_UPPS_NU_avg_PO)
#EarlyLut as reference group
Phase_UPPS_NU_avg_EL <- lmerTest::lmer(UPPS_NU_avg ~ midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_UPPS_NU_avg_EL)
#Midluteal as reference group
Phase_UPPS_NU_avg_ML <- lmerTest::lmer(UPPS_NU_avg ~ midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_UPPS_NU_avg_ML)
#Perimenstrual as reference group
Phase_UPPS_NU_avg_PM <- lmerTest::lmer(UPPS_NU_avg ~ midfol_LH + periov_LH +earlylut_LH + midluteal_LH
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_UPPS_NU_avg_PM)

#Hormone effects
UPPS_NU_avg_hormones <- lmerTest::lmer(UPPS_NU_avg ~ Estradiol.d + Progesterone.d + Estradiol.d*Progesterone.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(UPPS_NU_avg_hormones)
```
#Graphing personality by phase
```{r}
#Plot Daily Data by Phase
#set up labels
AdultADHDDailyData$cyclephase_names <- factor(AdultADHDDailyData$cyclephase_LH, levels = c(1,2,3,4,5), labels = c("PO", "EL", "ML", "PM", "MF"))
...
#person-mean-center
data_for_plot1a <- AdultADHDDailyData %>% group_by(ID, cyclephase_names) %>% 
  summarize(UPPS_NU_avg.m=mean(UPPS_NU_avg.m),
            UPPS_NU_avgphase.m = mean(UPPS_NU_avg, na.rm = TRUE),
            UPPS_NU_avgphase.d = UPPS_NU_avgphase.m - UPPS_NU_avg.m)%>%
filter(!is.na(cyclephase_names))

plot1a <- data_for_plot1a %>% 
  group_by(cyclephase_names) %>%
  summarize(grand.m.UPPS_NU_avg.d = mean(UPPS_NU_avgphase.d, na.rm=T),
            se=sd(UPPS_NU_avgphase.d, na.rm=T)/sqrt(n())) %>%
  #can save the above code into a separate dataset if preferred (dont have to do it in one line w/ ggplot)
  ggplot(aes(x=cyclephase_names, y=grand.m.UPPS_NU_avg.d))+
  geom_line(group=1)+
  ##everything from here down is just formatting
  scale_x_discrete(labels=c("PO" = "Periovulatory",
                            "EL" = "Earlyluteal",
                            ...
                            "PM" = "Perimenstrual",
                            "MF" = "Midfollicular" ))+
  geom_errorbar(aes(ymin=grand.m.UPPS_NU_avg.d-se, 
                    ymax=grand.m.UPPS_NU_avg.d+se), 
                size=0.5, width=0.5, position=position_dodge())+
  geom_hline(yintercept=0.0, color="red", linetype="dashed")+
  theme_bw()+
  xlab("Cycle Phase")+
  ylab("Person-Centered Negative Urgency")
#run plot1a in console to see plot
plot1a
```
...
#Midfol as reference group
Phase_IA_Count_MF <- lmerTest::lmer(IA_Count ~ UPPS_PU_avg.d*(periov_LH + earlylut_LH + midluteal_LH + perimenstrual_LH) 
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_IA_Count_MF)
#PeriOv as reference group
Phase_IA_Count_PO <- lmerTest::lmer(IA_Count ~ UPPS_PU_avg.d*(midfol_LH + earlylut_LH + midluteal_LH + perimenstrual_LH)
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_IA_Count_PO)
#EarlyLut as reference group
Phase_IA_Count_EL <- lmerTest::lmer(IA_Count ~ UPPS_PU_avg.d*(midfol_LH + periov_LH + midluteal_LH + perimenstrual_LH)
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_IA_Count_EL)
#Midluteal as reference group
Phase_IA_Count_ML <- lmerTest::lmer(IA_Count ~ UPPS_PU_avg.d*(midfol_LH + periov_LH +earlylut_LH + perimenstrual_LH)
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_Hyp_Count_ML)
#Perimenstrual as reference group
Phase_Hyp_Count_PM <- lmerTest::lmer(Hyp_Count ~ UPPS_PU_avg.d*(midfol_LH + periov_LH +earlylut_LH + midluteal_LH)
                                     +(1|ID),
                                     data = AdultADHDDailyData) 
summary(Phase_Hyp_Count_PM)

#Hormone effects
IA_hormones <- lmerTest::lmer(IA_Count ~ Progesterone.d*UPPS_Persev_avg.d 
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(IA_hormones)

IA_hormones <- lmerTest::lmer(IA_Count ~ Progesterone.d + UPPS_NU_avg.d + Progesterone.d*UPPS_NU_avg.d
                                     +(1 |ID),
                                     data = AdultADHDDailyData) 
summary(IA_hormones)
