...
tab_model(model1ar, model1b, model1c, model1dr)
...
# EARLY LUT REF - RANDOM EFFECTS CHANGES
model1dr <- lmer(DRSP_2 ~ periov_LH+ midfol_LH+perimenstrual_LH + midluteal_LH+
              (1 + NON_OV | ID), data = AdultADHDDailyData)
...
tab_model(model1ar, model1br, model1cr, model1dr)
...
# PERIMENS REF
model1ar <- lmer(DRSP_3 ~ midluteal_LH +earlylut_LH+periov_LH + midfol_LH + 
              (1 + NON_PERI  | ID), data = AdultADHDDailyData)
...
# PERIOV REF
model1dr <- lmer(DRSP_3 ~midfol_LH+perimenstrual_LH + midluteal_LH+ earlylut_LH+
              (1 + NON_OV | ID), data = AdultADHDDailyData)
...
#FINAL ANXIETY MODELS

tab_model(model1a, model1b, model1cr, model1dr)
...
tab_model(model1a, model1br, model1cr, model1dr)
