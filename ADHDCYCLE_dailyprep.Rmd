...
# peri and midfol = 16
# midlut and peri- 103
# earlylut and peri = 30
# periov and perimens = 52
...
# 7/9/24: 208 216 225 251 264 270 279 281 286 312 331 332
...
plot_participant_data(df, 208, "CSS_Fx_Total", "CSS Function", dailydir)


# Check if filtering returns any rows for this pt
filtered_df <- df %>% filter(id == 208)
print(filtered_df)

df %>%
  filter(id==208) %>% 
  select(id, date_rated, LHposdayfirst, daycountLH,
         mensdayonefirst, StartPeriod, cycleday,
         midfol_LH, periov_LH, earlylut_LH,
         midluteal_LH, perimenstrual_LH, cyclephase_LH) %>% View() 
...
## - MIDFOL and PERI OVERLAP: 208 216 225 251 264 270 279 281 286 312 331 332
