...
#plot_participant_data(df, 205, "CSS_Fx_Total", "CSS Functional Impact", dailydir)
...
# Temporary Chunk -- Run quick hormone models for michelle - INATT
```{r}
...
# Temporary Chunk -- Run quick hormone models for michelle 
```{r}
...
plot_interaction <- function(data, outcome) {
  ...
  # Fit the model with cleaned data
  model <- lmer(log_outcome ~ E2zd * P4zd + (1 + P4zd| id), data = data_clean)
